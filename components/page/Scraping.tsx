...
const Scraping = () => {
  return (
    <div className="flex flex-col w-full items-center px-2 md:p-24" id="ministries">
      <div className="flex flex-col items-center text-center gap-4">
        <span className="text-blue-500 font-extrabold text-sm md:text-lg">
          Vast Knowledge
        </span>
      ...
      <div className="max-w-6xl mx-auto px-8 md:mt-16">
